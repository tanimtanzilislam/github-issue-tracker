...
<form method="dialog" class="modal-box max-w-4xl rounded-2xl p-10">
    ...
    <p class="mt-8 text-lg text-slate-500 leading-8">
        ${issue.description}
    </p>

    <div class="grid grid-cols-2 gap-5 bg-slate-50 rounded-xl p-6 mt-8">
    ...
    <div class="modal-action">
        ...
        <button class="btn bg-purple-700 text-white border-0 hover:bg-purple-800">
            Close
        </button>
