...
<div class="flex justify-between items-center w-[636px] h-[81px] bg-[#F8FAFC] px-6 rounded-lg">

    <div class="flex justify-between w-[636px] bg-[#F8FAFC] p-6 rounded-lg">

    <div>
        <p class="text-[#64748B]">Assigned:</p>
        <p class="font-semibold">
            ${issue.assignee === "" ? "Unassigned" : issue.assignee}
        </p>
    </div>
